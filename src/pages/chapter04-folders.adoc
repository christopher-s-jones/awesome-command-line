...
image::chapter-04-path-expansion.png[title="Using pattern matching to enable path expansion in commands on macOS.", pdfwidth=100%]
...
[source, console, caption="Example {counter:listing-counter}: "]
----
chris@ophir Photography % cd Photography
